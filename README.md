...
One can install it either directly from <!--replace: VIRTUALHID_VERSION-->[Karabiner-DriverKit-VirtualHIDDevice](https://github.com/pqrs-org/Karabiner-DriverKit-VirtualHIDDevice/releases#release-v6.10.0), or along with <!--replace: ELEMENTS_VERSION-->[Karabiner Elements](https://github.com/pqrs-org/Karabiner-Elements/releases#release-v15.9.0).

The maximum supported versions of Karabiner-Element currently are:
| Package                              | Version                                     |
|--------------------------------------|---------------------------------------------|
| Karabiner-DriverKit-VirtualHIDDevice | <!--replace: VIRTUALHID_VERSION-->`6.10.0`  |
| Karabiner-Elements                   | <!--replace: ELEMENTS_VERSION-->`15.9.0` |
